                    ...
                    <div className="bg-black rounded shadow-x p-7 sm:p-10">
                        ...
                        >
                            ...
                            <div className="mb-1 sm:mb-2">
                                <label className="inline-block mb-1 text-xl font-medium pb-2">Enter
                                    Destination</label>
                                <input
                            ...
                            <div className="flex pt-2 ">
                                ...
                                <div
                                    className="flex items-center justify-center flex-col border-2 border-black bg-white  w-36 h-36">
                                    <svg
                                width="42"
                                height="48"
                                viewBox="0 0 42 48"
