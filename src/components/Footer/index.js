  ...
  return (
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <a href="https://flowbite.com" className="flex items-center mb-4 sm:mb-0">
            <img src="./images/logo.png" className="mr-3 h-8" alt="Seconds Logo" />
    ...
    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" className="hover:underline">Seconds™</a>. All Rights Reserved.
    </span>
</footer>
    </div>
  )
